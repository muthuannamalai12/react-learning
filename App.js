...
// Destructuring the props on the fly in the  argument section
  ...
  return (
    <div className="body">
      ...
      <div className="restaurant-container">
        {/* Way to send props as individual fields
        <RestaurantCard resName="Meghana" />
        <RestaurantCard resName="KFC" /> */}
        {/* Way to send props as entire object */}
        {/* <RestaurantCard resData={resList} /> */}
        {/* {
        resList.map(restaurant) => 
          RestaurantCard resData = {resList}
        } */}
        {/* Not good way of sending data
